    ...
    <section id="product" className={`${layout.sectionReverse}`}>
      ...
      <div className={`${layout.sectionInfo}`}>
        ...
        <div className="flex flex-row flex-wrap sm:mt-10 mt-6">
          <img src={apple} alt="apple" className="w-[128px] h-[42px] cursor-pointer mr-5 object-contain" />
          <img src={google} alt="apple" className="w-[128px] h-[42px] cursor-pointer object-contain" />
